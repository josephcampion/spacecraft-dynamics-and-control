...
class DrawMav:
    ...
    def get_points(self):
        ...
        # for i in range(len(meshColors)):
        #     meshColors[i] = colorOptions[i%len(colorOptions)]
    ...
    def points_to_mesh(self, points):
        ...
        """
        points = points.T
        mesh = np.array([[points[0], points[1], points[4]],
                         ...
                         [points[3], points[0], points[7]],
                         [points[0], points[7], points[4]],
                         [points[8], points[9], points[10]],
                         [points[8], points[11], points[10]],
